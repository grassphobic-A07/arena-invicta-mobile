...
Secara garis besar, integrasi Arena Invicta Mobile dengan web service Arena Invicta (Django, Proyek Tengah Semester) dilakukan melalui tahapan berikut **(bagian ini dapat berubah sewaktu-waktu)**:
